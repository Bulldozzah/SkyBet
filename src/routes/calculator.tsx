...
function CalculatorPage() {
  ...
  return (
    <AppShell>
      ...
      {/* Event-count tabs */}
      <div className="mb-4 inline-flex rounded-lg border border-border bg-card p-1" role="tablist">
        {TEAM_TABS.map((n) => (
          <button
            key={n}
            role="tab"
        ...
        <div className="space-y-3">
          {Array.from({ length: activeTeams }).map((_, t) => {
            ...
            return (
              <div
                key={TEAM_LETTERS[t]}
                className="grid grid-cols-[auto_minmax(0,1fr)] items-center gap-2 sm:grid-cols-[auto_minmax(0,1.4fr)_repeat(3,minmax(0,1fr))]"
              >
      ...
      <div className="card mb-4 flex flex-wrap items-center gap-3">
        ...
        <input
          type="text"
          placeholder="Bet name (defaults to date & time)"
          value={betTitle}
